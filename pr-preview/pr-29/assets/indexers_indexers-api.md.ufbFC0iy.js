import{r as e,R as s,c as m}from"./chunks/client.r8mSQ1EB.js";import{L as f,P as v}from"./chunks/PlayIcon.2awFFRWP.js";import{c as u}from"./chunks/common.HiEjcPH8.js";import{h as B,l as x,c as A,m as b,U as q,o as D}from"./chunks/framework.eFvaniAw.js";const N=()=>{const o="https://gql-router.xdefi.services/graphql",[y,t]=e.useState(!1),[d,l]=e.useState({}),[k,F]=e.useState(void 0),[p,E]=e.useState(void 0),[r,h]=e.useState("");e.useEffect(()=>{k?u.find(i=>{i.key===k&&(E(i),h(i.exampleAddress||""))}):(E(void 0),h("")),l({})},[k]);const g=async()=>{const i=`query GetBalances($address: String!, $tokenAddresses: [String!]) {
      ${p.key} {
    ...
    }`;await fetch(o,{method:"POST",headers:{"Content-Type":"application/json","apollographql-client-name":"docs-indexers-api","apollographql-client-version":"v1.0"},body:JSON.stringify({query:i,variables:{address:r,first:1,after:null}})}).then(n=>n.json()).then(n=>{t(n)}).catch(n=>{t(n)}).finally(()=>{l(!1)})},c=async()=>{if(l(!0),t({}),!p){alert("Please select a chain first!"),l(!1);return}if(!r){alert("Please enter an address!"),l(!1);return}switch(p.baseChain){case"CosmosChain":g();break;case"EVM":C();break;default:a();break}};return s.createElement(s.Fragment,null,s.createElement("div",{className:"flex items-center gap-4"},s.createElement("div",{className:"flex items-center gap-4"},s.createElement("span",null,"Chain:"),s.createElement("div",{className:"border border-[#e2e2e3] dark:border-[#2e2e32] hover:border-[#3451b2] rounded-lg overflow-hidden w-fit"},s.createElement("select",{id:"chain-select",name:"chain-select",className:"bg-gray-50 text-gray-900 px-2 py-1 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white",onChange:i=>F(i.target.value)},s.createElement("option",{value:void 0},"Select a chain"),u.map(i=>s.createElement("option",{key:i.key,value:i.key},i.label,i.baseChain&&s.createElement(s.Fragment,null," (",i.baseChain,")")))))),s.createElement("div",{className:"flex items-center gap-4"},s.createElement("span",null,"Address:"),s.createElement("div",{className:"border border-[#e2e2e3] dark:border-[#2e2e32] hover:border-[#3451b2] rounded-lg overflow-hidden w-fit"},s.createElement("input",{type:"text",id:"address",name:"Address",value:r,className:"bg-gray-50 text-gray-900 px-2 py-1 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white",placeholder:"Enter an address",onChange:i=>h(i.target.value)})))),s.createElement("div",{className:"flex justify-center mt-4"},s.createElement("button",{onClick:c,className:"flex justify-center items-center gap-2 bg-[#2770CB] text-white px-2 py-1 rounded",disabled:d},d?s.createElement(s.Fragment,null,s.createElement(f,null),"Fetching..."):s.createElement(s.Fragment,null,s.createElement(v,null),"Test the query"))),s.createElement("div",{className:"my-4 rounded-lg max-h-[600px] overflow-auto bg-[#F6F6F7] text-[#24292E] dark:bg-[#161618] dark:text-[#E1E4E8]"},s.createElement("div",{className:"px-5 border-b border-[#e2e2e3] dark:border-black"},s.createElement("span",{className:"inline-block border-b-2 border-[#3451b2] dark:border-[#a8b1ff] text-[14px] leading-[48px]"},"Response")),s.createElement("pre",{className:"p-5"},JSON.stringify(y,null,2))))},P=()=>{const o="https://gql-router.xdefi.services/graphql",[y,t]=e.useState({}),[d,l]=e.useState(!1),[k,F]=e.useState(void 0),[p,E]=e.useState(void 0);e.useEffect(()=>{k?u.find(h=>{h.key===k&&E(h)}):E(void 0),t({})},[k]);const r=async()=>{if(l(!0),t({}),!p){alert("Please select a chain first!"),l(!1);return}let h="";switch(p.key){case"ethereum":case"cantoEVM":case"cronosEVM":case"gnosis":h=`query GetFee {
          ${p.key} {
            fee {
              defaultGasPrice
              high {
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(result);</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // Do something with the result</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  });</span></span></code></pre></div></div></div>`,7),w=q(`<h2 id="get-activity-history" tabindex="-1">Get Activity History <a class="header-anchor" href="#get-activity-history" aria-label="Permalink to &quot;Get Activity History&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-JsnR_" id="tab-bHxigt_" checked="checked"><label for="tab-bHxigt_">EVM Chain</label><input type="radio" name="group-JsnR_" id="tab--rrB1lG"><label for="tab--rrB1lG">CosmosChain</label><input type="radio" name="group-JsnR_" id="tab-IhJa_5D"><label for="tab-IhJa_5D">Other Chain</label></div><div class="blocks"><div class="language-javascript vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark has-highlighted vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> GRAPHQL_ENDPOINT</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://gql-router.xdefi.services/graphql&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(result);</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // Do something with the result</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  });</span></span></code></pre></div></div></div><p>View more about raw transaction hex <a href="https://www.blockchain.com/explorer/assets/btc/decode-transaction" target="_blank" rel="noreferrer">here</a>.</p>`,3),J=JSON.parse('{"title":"Indexers API","description":"","frontmatter":{"head":[["meta",{"name":"og:title","content":"Indexers API | XDEFI Dev Docs"},{"name":"og:description","content":false}]]},"headers":[],"relativePath":"indexers/indexers-api.md","filePath":"indexers/indexers-api.md","lastUpdated":1712284840000}'),j={name:"indexers/indexers-api.md"},Q=Object.assign(j,{setup(o){const y=B(),t=B(),d=B(),l=B(),k=B();return x(()=>{m(y.value).render(e.createElement(N,{},null)),m(t.value).render(e.createElement(T,{},null)),m(d.value).render(e.createElement(P,{},null)),m(l.value).render(e.createElement(S,{},null)),m(k.value).render(e.createElement(_,{},null))}),(F,p)=>(D(),A("div",null,[G,b("div",{ref_key:"refGetBalance",ref:y},null,512),w,b("div",{ref_key:"refGetTransaction",ref:t},null,512),O,b("div",{ref_key:"refGetGasFee",ref:d},null,512),$,b("div",{ref_key:"refGetUTXOs",ref:l},null,512),I,b("div",{ref_key:"refBroadcastTransaction",ref:k},null,512)]))}});export{J as __pageData,Q as default};
