import{r as n,R as s,c as C}from"./chunks/client.r8mSQ1EB.js";import{L as f,P as v}from"./chunks/PlayIcon.2awFFRWP.js";import{c as u}from"./chunks/common.5bIqE6T0.js";import{h as b,l as q,c as A,m as B,U as x,o as N}from"./chunks/framework.5mpzq0ZH.js";const T=()=>{const g="https://gql-router.xdefi.services/graphql",[y,t]=n.useState(!1),[d,l]=n.useState({}),[r,F]=n.useState(void 0),[p,E]=n.useState(void 0),[k,h]=n.useState("");n.useEffect(()=>{r?u.find(a=>{a.key===r&&(E(a),h(a.exampleAddress||""))}):(E(void 0),h("")),l({})},[r]);const o=async()=>{const a=`query GetBalances($address: String!, $tokenAddresses: [String!]) {
      ${p.key} {
