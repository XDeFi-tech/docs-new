import{r as e,R as s,c as d}from"./chunks/client.MWnTFKPL.js";import{L as c,P as F}from"./chunks/PlayIcon.COpKDN9o.js";import{h as g,l as u,c as B,m as E,U as y,a as A,o as m}from"./chunks/framework.foeC49A9.js";const f="/pr-preview/pr-22/assets/subscription-service.VyDw3PS4.png",b=()=>{const r="https://gql-router.xdefiservices.com/graphql",[t,a]=e.useState({}),[l,n]=e.useState(!1),p=`
  ...
  }`,h={page:{first:5,after:null},filter:{ids:null},after:null,afterPrice:null},k=async()=>{n(!0),a({}),await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:p,variables:h})}).then(i=>i.json()).then(i=>{a(i)}).catch(i=>{a(i)}).finally(()=>{n(!1)})};return s.createElement(s.Fragment,null,s.createElement("div",{className:"flex justify-center"},s.createElement("button",{onClick:k,className:"flex justify-center items-center gap-2 bg-[#2770CB] text-white px-2 py-1 rounded",disabled:l},l?s.createElement(s.Fragment,null,s.createElement(c,null),"Fetching..."):s.createElement(s.Fragment,null,s.createElement(F,null),"Test the query"))),s.createElement("div",{className:"my-4 rounded-lg max-h-[600px] overflow-auto bg-[#F6F6F7] text-[#24292E] dark:bg-[#161618] dark:text-[#E1E4E8]"},s.createElement("div",{className:"px-5 border-b border-[#e2e2e3] dark:border-black"},s.createElement("span",{className:"inline-block border-b-2 border-[#3451b2] dark:border-[#a8b1ff] text-[14px] leading-[48px]"},"Response")),s.createElement("pre",{className:"p-5"},JSON.stringify(t,null,2))))},x=()=>{const r="https://gql-router.xdefiservices.com/graphql",[t,a]=e.useState({}),[l,n]=e.useState(!1),p=`
  ...
  }`,h={page:{first:5,after:null,before:null,last:null},filter:{symbols:null,ids:null,chains:null,address:null},after:null,afterPrice:null},k=async()=>{n(!0),a({}),await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:p,variables:h})}).then(i=>i.json()).then(i=>{a(i)}).catch(i=>{a(i)}).finally(()=>{n(!1)})};return s.createElement(s.Fragment,null,s.createElement("div",{className:"flex justify-center"},s.createElement("button",{onClick:k,className:"flex justify-center items-center gap-2 bg-[#2770CB] text-white px-2 py-1 rounded",disabled:l},l?s.createElement(s.Fragment,null,s.createElement(c,null),"Fetching..."):s.createElement(s.Fragment,null,s.createElement(F,null),"Test the query"))),s.createElement("div",{className:"my-4 rounded-lg max-h-[600px] overflow-auto bg-[#F6F6F7] text-[#24292E] dark:bg-[#161618] dark:text-[#E1E4E8]"},s.createElement("div",{className:"px-5 border-b border-[#e2e2e3] dark:border-black"},s.createElement("span",{className:"inline-block border-b-2 border-[#3451b2] dark:border-[#a8b1ff] text-[14px] leading-[48px]"},"Response")),s.createElement("pre",{className:"p-5"},JSON.stringify(t,null,2))))},q=()=>{const[r,t]=e.useState({}),[a,l]=e.useState(!1),n=new WebSocket("wss://subscription-service.dev.xdefi.services/graphql"),p=`subscription Subscription($ids: [String!]) {
    price(ids: $ids) {
      chain
      id
      price {
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">subscriptionServices</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div></div></div>`,6),$=JSON.parse('{"title":"Assets and Prices API","description":"","frontmatter":{"head":[["meta",{"name":"og:title","content":"Assets and Prices API | XDEFI Dev Docs"},{"name":"og:description","content":false}]]},"headers":[],"relativePath":"assets-services/assets-and-prices-api.md","filePath":"assets-services/assets-and-prices-api.md","lastUpdated":1711448369000}'),G={name:"assets-services/assets-and-prices-api.md"},J=Object.assign(G,{setup(r){const t=g(),a=g(),l=g(),n=g(),p=g();return u(()=>{d(t.value).render(e.createElement(b,{},null)),d(a.value).render(e.createElement(v,{},null)),d(l.value).render(e.createElement(D,{},null)),d(n.value).render(e.createElement(x,{},null)),d(p.value).render(e.createElement(q,{},null))}),(h,k)=>(m(),B("div",null,[P,E("div",{ref_key:"refAssetsTokens",ref:t},null,512),S,E("div",{ref_key:"refAssetsCryptoCurrencies",ref:a},null,512),T,E("div",{ref_key:"refAssetsFiatCurrencies",ref:l},null,512),N,E("div",{ref_key:"refAssetsLPTokens",ref:n},null,512),I,Q,E("div",_,null,512),L,E("div",{ref_key:"refSubscriptionService",ref:p},null,512)]))}});export{$ as __pageData,J as default};
